...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to ImageFolder dataset root for zero-shot evaluation.",
    )
    parser.add_argument(
        "--cache-dir",
        type=str,
    ...
    parser.add_argument(
        ...
        default=None,
        type=float,
        help="Override the patch select during training, for intelligent patch selection based on information content",
    )
    parser.add_argument(
        "--force-custom-text",
        default=False,
    ...
    parser.add_argument(
        "--coca-multi-scale-caption-loss-weight",
        type=float,
        default=0.2,
        help="Weight assigned to multi-scale caption loss in CoCa."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable InfoBatch for accelerated training by pruning less informative samples."
    )
    parser.add_argument(
        '--grad_clip_norm', 
        type=float, 
