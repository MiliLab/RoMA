...
def create_model(
        ...
        force_patch_select: Optional[float] = None,
    ...
    Args:
        ...
        force_patch_select: Override patch select value in model config.
    ...
    if force_patch_select is not None:
        vision_cfg["patch_select"] = force_patch_select
    ...
    if "patch_size" in model_kwargs:
        vision_cfg["patch_size"] = model_kwargs.pop("patch_size")
    if "image_size" in model_kwargs:
        vision_cfg["image_size"] = model_kwargs.pop("image_size")
...
def create_loss(args):
    if args.distill:
        ...
        return CoCaLoss(
            multi_scale_caption_loss_weight=args.coca_multi_scale_caption_loss_weight,
            caption_loss_weight=args.coca_caption_loss_weight,
            # multi_scale_image_loss_weight=args.coca_multi_scale_image_loss_weight,
            # image_loss_weight=args.coca_image_loss_weight,
...
def create_model_and_transforms(
    ...
    model = create_model(
        ...
        force_patch_select=force_patch_select,
