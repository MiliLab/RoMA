...
class CLIPVisionCfg:
    ...
    patch_select: float = 0.  # what fraction of patches to keep using intelligent selection (0 would mean disabled) - alternative to patch_dropout
...
def _build_vision_tower(
    ...
    if getattr(vision_cfg, "timm_model_name", None) == "vision_mamba":
        visual = VisionMamba(
        ...
        visual = VisionTransformer(
            ...
            patch_select=vision_cfg.patch_select,
            attentional_pool=vision_cfg.attentional_pool,
            attn_pooler_queries=vision_cfg.attn_pooler_queries,
            attn_pooler_heads=vision_cfg.attn_pooler_heads,
